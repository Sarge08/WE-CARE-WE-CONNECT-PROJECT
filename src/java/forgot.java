...
public class forgot extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
            ...
            if(phn.equals(phn1))
            {
                PreparedStatement pstmt=con.prepareStatement("update signup set pwd=?  where phn=?");
                ...
                out.println("<body>");
                out.println("<script type=\"text/javascript\">");  
                out.println("alert('update unsucessfull');");  
                out.println("window.location.href = 'forgot.html';");
                out.println("</script>");
                out.println("</body>");
                out.println("</html>");
                }
